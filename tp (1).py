...
def binarize(img):
    ...
    Devuelve un array de bits (aplanado).
    """
...
def resize_secret_to_capacity(secret_img, capacity_bits):
    """
    Dado que capacity_bits es el número máximo de bits que podemos ocultar,
    redimensiona la imagen secreta (escala de grises) a un cuadrado cuyo número
    de píxeles no exceda capacity_bits.
    """
